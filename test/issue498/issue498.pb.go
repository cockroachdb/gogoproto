...
var fileDescriptor_fe85d52248c43d9d = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Int16 == nil {
		return 0, github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("int16")
	} else {
	...
	if m.Int8 == nil {
		return 0, github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("int8")
	} else {
	...
	if m.Uint16 == nil {
		return 0, github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("uint16")
	} else {
	...
	if m.Uint8 == nil {
		return 0, github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("uint8")
	} else {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("uint8")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("uint16")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("int8")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return github_com_cockroachdb_gogoproto_proto.NewRequiredNotSetError("int16")
	}
