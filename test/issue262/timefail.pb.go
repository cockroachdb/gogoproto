...
var fileDescriptor_395e61815f86626a = []byte{
	...
	0x4d, 0x4b, 0xcc, 0xcc, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0xa5, 0x4c,
	...
	0x03, 0xa4, 0xe4, 0xd3, 0xf3, 0xf3, 0xd3, 0x73, 0x52, 0xf5, 0xc1, 0xbc, 0xa4, 0xd2, 0x34, 0x7d,
	0x90, 0x81, 0xc5, 0x25, 0x89, 0xb9, 0x05, 0x10, 0x05, 0x4a, 0x9e, 0x5c, 0x1c, 0x21, 0x99, 0xb9,
	0xa9, 0x6e, 0x89, 0x99, 0x39, 0x42, 0xb6, 0x5c, 0x9c, 0x20, 0xe9, 0xf8, 0x92, 0xd4, 0xe2, 0x12,
	0x09, 0x46, 0x05, 0x46, 0x0d, 0x6e, 0x23, 0x29, 0x3d, 0x88, 0x01, 0x7a, 0x30, 0x03, 0xf4, 0x42,
	0x60, 0x06, 0x38, 0xb1, 0x4c, 0xb8, 0x2f, 0xcf, 0x18, 0x04, 0x76, 0x62, 0x48, 0x6a, 0x71, 0x89,
	...
	0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0xc9, 0xc6, 0x80, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x2e, 0x6f, 0x35, 0xbe, 0xfb, 0x00, 0x00, 0x00,
}
...
func (m *TimeFail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TimeTest != nil {
		n1, err1 := github_com_cockroachdb_gogoproto_types.StdTimeMarshalTo(*m.TimeTest, dAtA[i-github_com_cockroachdb_gogoproto_types.SizeOfStdTime(*m.TimeTest):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *TimeFail) Size() (n int) {
	...
	_ = l
	if m.TimeTest != nil {
		l = github_com_cockroachdb_gogoproto_types.SizeOfStdTime(*m.TimeTest)
...
func (m *TimeFail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_cockroachdb_gogoproto_types.StdTimeUnmarshal(m.TimeTest, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
