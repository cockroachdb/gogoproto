...
var fileDescriptor_35fa31fa2023935a = []byte{
	...
	0x4d, 0x35, 0x32, 0x33, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0xa5, 0x4c,
	...
	,
	...
	0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x89, 0x0d, 0x6c, 0xa6, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0xf8, 0x24, 0xda, 0xe7, 0x7e, 0x01, 0x00, 0x00,
}
...
func (m *MapStdTypes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NullableDuration) > 0 {
		for k := range m.NullableDuration {
			...
			baseI := i
			if v != nil {
				n1, err1 := github_com_cockroachdb_gogoproto_types.StdDurationMarshalTo((*v), dAtA[i-github_com_cockroachdb_gogoproto_types.SizeOfStdDuration((*v)):])
				if err1 != nil {
					return 0, err1
				}
				i -= n1
